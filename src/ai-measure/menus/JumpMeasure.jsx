  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <h2 className="text-lg font-black">점프 · 반동점프</h2>
        <span className="w-12" />
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-3">
        ...
        <div>
          ...
          <input type="number" step="0.1" value={weight} onChange={e => setWeight(e.target.value)}
            placeholder="70" className="w-full bg-slate-800 border border-slate-700 text-slate-100 rounded-xl px-3 py-2.5 text-sm font-mono focus:outline-none focus:border-amber-500" />
        </div>
      </div>

      <button onClick={calc} className="w-full rounded-xl bg-amber-500 text-slate-950 font-bold py-3 text-sm">점프 분석</button>
