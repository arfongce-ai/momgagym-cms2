...
import StanceLiveAnalysis from '../ai-measure/menus/StanceLiveAnalysis';
...
describe('stance UI 컴포넌트 임포트/문법 스모크 테스트', () => {
  ...
  it('StanceLiveAnalysis는 함수 컴포넌트로 정상 임포트된다', () => {
    expect(typeof StanceLiveAnalysis).toBe('function');
  });
